...
$string['googlebadformat'] = 'Google bad response format';
$string['googledeniedservice'] = 'Google denied service. Reason : {$a}';
...
$string['pluginname'] = 'Extra plotting libraries for APL plugins';
$string['privacy:metadata'] = 'The Local APLPlot plugin does not store any personal data about any user.';
