 ...
 * @module     local_aplplot/chart_builder
 */
define(['jquery'], function($) {
     ...
     * Chart builder.
     *
     * @exports local_aplplot/chart_builder
     */
    var module = {
         ...
         * deferring most of the logic to {@link module:local_aplplot/chart_base.create}.
         *
        ...
        make: function(data) {
            ...
            require(['local_aplplot/chart_' + data.type], function(Klass) {
