 ...
 * @module     local_aplplot/chart_base
 */
define(['core/chart_series', 'core/chart_axis'], function(Series, Axis) {
     ...
     *
     * {@link module:local_aplplot/chart_base#_setDefault} to set the defaults on instantiation.
     *
     * @alias module:local_aplplot/chart_base
     * @class
     */
    function Base() {
        this._series = [];
     ...
     *
     * @protected
     * @type {module:local_aplplot/chart_series[]}
     */
     ...
     *
     * @protected
     * @type {module:local_aplplot/chart_axis[]}
     */
     ...
     *
     * @param {module:local_aplplot/chart_series} series The series to add.
     */
     ...
     * @static
     * @method create
     * @param {module:local_aplplot/chart_base} Klass The class oject representing the type of chart to instantiate.
     * @param {Object} data The data of the chart.
     * @return {module:local_aplplot/chart_base}
     */
     ...
     * @return {module:local_aplplot/chart_axis}
     */
     ...
     * Get the series.
     *
     * @return {module:local_aplplot/chart_series[]}
     */
     ...
     *
     * @see module:local_aplplot/chart_base#TYPE
     * @return {String}
     */
     ...
     *
     * @param {module:local_aplplot/chart_axis} axis The axis.
     * @param {Number} [index=0] The index of the axis.
     */
     ...
     * @param {module:local_aplplot/chart_axis} axis The axis to validate.
     * @param {Number} [index=0] The index of the axis.
     */
     ...
     *
     * @protected
     * @param {module:local_aplplot/chart_series} series The series to validate.
     */
