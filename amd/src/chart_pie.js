...
/**
 * Extended Chart pie. We need more control upon colorsets and options.
 *
 * @copyright  2022 Valery Fremaux - www.activeprolearn.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @module     local_aplplot/chart_pie
 */
define(['local_aplplot/chart_base'], function(Base) {

    /**
     * Pie chart.
     *
     * @class
     * @alias module:local_aplplot/chart_pie
     * @extends {module:local_aplplot/chart_base}
     */
    function Pie() {
